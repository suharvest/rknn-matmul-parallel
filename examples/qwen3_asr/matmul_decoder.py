    ...
    def __init__(self,
        ...
        try:
            ...
            raise ImportError(
                ...
                "Build it from the rknn-matmul-parallel root: make python\n"
                "Then add the project root to sys.path or PYTHONPATH."
            ) from e
        ...
        if weights_ready:
            ...
            logger.warning(
                ...
                "Export with: python export_weights.py --output %s",
